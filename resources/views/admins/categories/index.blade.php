...
<div class="card shadow mb-4">
    ...
    <div class="card-body">
        ...
        <div class="table-responsive">
                ...
                <tbody>
                    @foreach ($categories as $key => $category)
                        <tr>
                            ...
                            <td width="25%">
                                <div style="width: 100%">
                                    <img src="{{ url('storage/categories/'.$category->image) }}" alt="" title="" style="width:100%"/>
                                </div>
                            </td>
                            <td width="15%">
                            ...
                            <td width="15%">
                                <a
                                    ...
                                    data-url="{{ route('category-detail',['id' => $category->id]) }}" 
                                    data-href="{{ route('category-update',['id' => $category->id]) }}"
                                    data-id="{{$category->id}}"
                                    data-active="{{$category->active}}"    
                                    data-src="{{ url('storage/categories/'.$category->image) }}"
                                >
                            ...
                            <div class="modal fade" id="deleteModal" tabindex="-1" aria-labelledby="deleteModalLabel" aria-hidden="true">
                                <div class="modal-dialog">
                                    ...
                                    <div class="modal-footer">
                                        ...
                                        <a href="{{route('category-delete', ['id' => $category->id])}}" class="btn btn-primary">Yes</a>
                                    </div>
                                    </div>
                                </div>
                            </div>
            ...
            {{ $categories->links('admins.paginate.view') }}
        </div>
    </div>
</div>
<!-- The Modal -->
<div class="modal" id="myModal">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <!-- Modal body -->
            <div class="modal-body">
                <form class="form-category" method="post" action="{{route('category-create')}}" enctype="multipart/form-data">
                    @csrf
